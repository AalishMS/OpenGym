...
// reps/weight are never persisted. Editing a plan via EditPlanScreen always destroys
// existing set data (resets to 8 reps, 0 kg). Fixing this requires a Hive model change
